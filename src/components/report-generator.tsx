  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-6">
      ...
      <Tabs defaultValue="employee">
        <TabsList className="w-full md:w-auto bg-slate-100 p-1.5 rounded-xl border border-slate-200/80 inline-flex gap-1.5 h-auto">
          <TabsTrigger
            value="employee"
            className="flex-1 md:flex-none rounded-lg px-4 py-2.5 text-sm font-medium transition-all duration-150 data-active:!bg-blue-600 data-active:!text-white data-active:!shadow-md !bg-transparent !text-slate-600 hover:bg-slate-200/60 flex items-center gap-2"
          >
            <User className="h-4 w-4 data-active:!text-white" />
            Report per Dipendente / Collaboratore
          </TabsTrigger>
          <TabsTrigger
            value="client"
            className="flex-1 md:flex-none rounded-lg px-4 py-2.5 text-sm font-medium transition-all duration-150 data-active:!bg-emerald-600 data-active:!text-white data-active:!shadow-md !bg-transparent !text-slate-600 hover:bg-slate-200/60 flex items-center gap-2"
          >
            <Building2 className="h-4 w-4 data-active:!text-white" />
            Report per Cliente
          </TabsTrigger>
        </TabsList>
